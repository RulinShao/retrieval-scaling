...
from massive_ds_flat import get_datastore
...
def load_config():
    ...
    cfg = hydra.compose(config_name="example_config")
...
if __name__ == '__main__':
    ...
    """
    curl -X POST rulin@a100-st-p4de24xlarge-176:49359/search -H "Content-Type: application/json" -d '{"query": "Where was Marie Curie born?", "n_docs": 1, "domains": "rpj_c4"}'
